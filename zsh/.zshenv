...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/home/trevor/.local/bin:/snap/bin:/usr/lib/llvm/9/bin:/usr/local/go/bin:/opt/homebrew/bin:$HOME/Library/Python/3.9/bin:$HOME/bin"
